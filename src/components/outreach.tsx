...
export function Outreach() {
	return(
		<div className={styles.main}>
			...
			<div className={`${styles.white_text} ${styles.futura_bold} ${styles.title}`}>
				OUTREACH
			</div>
			<div className={`${styles.white_text} ${styles.futura_bold} ${styles.subheading}`}>
			...
			<div className={styles.parallax} style={{ backgroundImage: `url(./outreach1.jpg)` }}>
			...
			<div className={`${styles.parallax} ${styles.outreach_images}`} style={{ backgroundImage: `url(./outreach2.jpg)` }} />
			<div className={styles.white_text}>
			...
			<div className={styles.parallax} style={{ backgroundImage: `url(./outreach3.jpg)` }} />
			<div className={styles.white_text}>
			...
			<figure className={styles.outreach_director}>
				...
				/>
				<figcaption className={`${styles.outreach_director_caption} ${styles.red_text}`}>
